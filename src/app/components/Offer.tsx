...
export default function OffersPage() {
    ...
    return (
        <section className="bg-gray-50 px-6 py-12 flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Offer 1 */}
                {offers[0] && (
                    <div className="flex items-center bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition duration-300 ease-in-out">
